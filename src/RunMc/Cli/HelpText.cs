...
public static class HelpText
{
    public static string For(HelpTopic topic) => topic switch
    {
        ...
        HelpTopic.Screenshot => "Usage: runmc screenshot --output <path.png> [--include-cursor] [--target <target>]",
        _ => "Usage: runmc [--target <target>] [click|hover|type|resize|screenshot] [--help]",
    };
}