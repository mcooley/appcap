...
$projectPath = Join-Path $PSScriptRoot 'RunMc.TestApp.csproj'
...
$msixPath = Join-Path $OutputDirectory 'RunMc.E2ETestApp.msix'
...
Get-Process -Name 'RunMc.TestApp' -ErrorAction SilentlyContinue | Stop-Process -Force
